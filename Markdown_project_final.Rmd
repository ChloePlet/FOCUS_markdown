...
![](resources/img/groundwater_sampling.jpg){width=200px}
...
```{r temperature_plot, out.width='60%', fig.align='center', fig.height= 4, fig.width=6}
...
Temperature_plot<- ggplot(data = subset(Field_NSW_figs, !is.na(Temperature)),
  ...
  labs(title = "Groundwater temperature (°C)")+
...
```{r Conductivity_plot, out.width='60%', fig.align='center', fig.height= 4, fig.width=6}
...
```{r pH_plot, out.width='60%', fig.align='center', fig.height= 4, fig.width=6}
...
```{r Eh_plot, out.width='60%', fig.align='center', fig.height= 4, fig.width=6}
