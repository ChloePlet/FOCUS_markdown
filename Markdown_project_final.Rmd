...
To do so I aimed to combine field observations and geolocation with a range of laboratory analyses. Unfortunately, this was too optimistic within Data School FOCUS timeframe and my personal availabilities. I have since simplified the dataset focusing on field collected data for this presentation.
...
Temperature_plot<- ggplot(data = Field_NSW,
  ...
  geom_sf(data = state_borders, inherit.aes = F)+
         geom_point()+
     scale_color_gradient2(low = "lightblue1", mid = "royalblue1", high = "firebrick1",midpoint = 18, space = "Lab", guide = "colourbar", aesthetics = "colour")+
