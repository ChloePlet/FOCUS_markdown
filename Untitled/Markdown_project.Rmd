...
# Introduction
With a background on biominerals, palaeoenvironemental reconstruction and organic geochemistry, I am now a postdoctoral researcher at CSIRO. Although I learned some matlab during my undergrad, I had never really understood it or used it. I was using excel, which often made me very frustrated. I really enjoyed the data school FOCUS and learning to "speak to computers". learning some R has definitely changed my perspective on how to record data, and given me a new view on time management when receiving large and complex excel datasheets. 
...
# My Project
I worked on hydrogeochemical data from NSW groundwater survey. My initial goal was to build a script that I could use for our groundwater surveys in Australia. These groundwater analyses initially focus on identifying buried mineral deposits, but also supply groundwater information to the population, and more specifically to the farmers who let us sample on their land. 
To do so I aimed to combine field observation, laboratory analyses, and geolocation. Unfortunately, this was too optimistic within Data School FOCUS timeframe and my personal availabilities. I have since simplified the dataset focusing on field collected data for this presentation.
